...
/*
 * SettingsEditFrame.java
 *
 * Created on 2008-12-13, 23:03:35
 */
...
public class SettingsEditFrame extends JPanel {
    ...
    private void initComponents() {
        ...
        columnBinding.setColumnClass(wdp.entities.raw.Worker.class);
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(idField, javax.swing.GroupLayout.DEFAULT_SIZE, 389, Short.MAX_VALUE)
                            .addComponent(keywordField, javax.swing.GroupLayout.DEFAULT_SIZE, 389, Short.MAX_VALUE)
                            .addComponent(valueStringField, javax.swing.GroupLayout.DEFAULT_SIZE, 389, Short.MAX_VALUE)
                            .addComponent(descriptionField, javax.swing.GroupLayout.DEFAULT_SIZE, 389, Short.MAX_VALUE)
                            .addComponent(idWorkerField, javax.swing.GroupLayout.DEFAULT_SIZE, 389, Short.MAX_VALUE)))
                    .addGroup(layout.createSequentialGroup()
                        .addContainerGap()
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<wdp.entities.raw.Settings> toRemove = new ArrayList<wdp.entities.raw.Settings>(selected.length);
        for (int idx=0; idx<selected.length; idx++) {
            wdp.entities.raw.Settings s = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(s);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        wdp.entities.raw.Settings s = new wdp.entities.raw.Settings();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<wdp.entities.raw.Settings> merged = new ArrayList<wdp.entities.raw.Settings>(list.size());
            for (wdp.entities.raw.Settings s : list) {
    ...
    private java.util.List<wdp.entities.raw.Settings> list;
