...
public class AssignmentEditFrame extends JPanel {
  
  public AssignmentEditFrame() {
    initComponents();
  ...
  private void initComponents() {
    ...
    org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(wdp.WdpApp.class).getContext().getResourceMap(AssignmentEditFrame.class);
      ...
      .addGroup(layout.createSequentialGroup()
        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
          ...
          .addGroup(layout.createSequentialGroup()
            ...
            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
              .addComponent(skillField, javax.swing.GroupLayout.DEFAULT_SIZE, 381, Short.MAX_VALUE)
              .addComponent(idWorkerField, javax.swing.GroupLayout.DEFAULT_SIZE, 381, Short.MAX_VALUE)
              .addComponent(idProjectField, javax.swing.GroupLayout.DEFAULT_SIZE, 381, Short.MAX_VALUE)
              .addComponent(idPostField, javax.swing.GroupLayout.DEFAULT_SIZE, 381, Short.MAX_VALUE)))
          .addGroup(layout.createSequentialGroup()
            .addContainerGap()
  ...
  private class FormListener implements java.awt.event.ActionListener {
    ...
    public void actionPerformed(java.awt.event.ActionEvent evt) {
      if (evt.getSource() == saveButton) {
        AssignmentEditFrame.this.saveButtonActionPerformed(evt);
      }
      else if (evt.getSource() == refreshButton) {
        AssignmentEditFrame.this.refreshButtonActionPerformed(evt);
      }
      else if (evt.getSource() == newButton) {
        AssignmentEditFrame.this.newButtonActionPerformed(evt);
      }
      else if (evt.getSource() == deleteButton) {
        AssignmentEditFrame.this.deleteButtonActionPerformed(evt);
      }
    }
  ...
  public static void main(String[] args) {
    EventQueue.invokeLater(new Runnable() {
      public void run() {
        ...
        frame.setContentPane(new AssignmentEditFrame());
